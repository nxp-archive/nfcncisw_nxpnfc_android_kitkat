...
public final class ApduServiceInfo implements Parcelable {
    ...
    public ApduServiceInfo(ResolveInfo info, boolean onHost, String description,
            ArrayList<AidGroup> aidGroups, boolean requiresUnlock, int bannerResource, ESeInfo seExtension) {
        this.mService = info;
    ...
    public ApduServiceInfo(PackageManager pm, ResolveInfo info, boolean onHost)
        ...
        try {
            if (onHost) {
                ...
                nxpParser = si.loadXmlMetaData(pm, OffHostApduService.NXP_NFC_EXT_META_DATA);
                if (parser == null) {
                    Log.d(TAG,"No " + OffHostApduService.NXP_NFC_EXT_META_DATA +
                            " meta-data");
                }
            }
    ...
    public static final Parcelable.Creator<ApduServiceInfo> CREATOR =
        ...
        public ApduServiceInfo createFromParcel(Parcel source) {
            ...
            return new ApduServiceInfo(info, onHost, description, aidGroups, requiresUnlock, bannerResource, seExtension);
        }
