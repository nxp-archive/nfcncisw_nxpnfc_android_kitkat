 ...
 ** Returns             Void
 *******************************************************************************/
void LLCP_SetStart_Symm (BOOLEAN start_symm)
{
    llcp_cb.lcb.start_symm = start_symm;
}
/*******************************************************************************
 ** Function            LLCP_GetStart_Symm
 **
 ...
 ** Returns             Void
 *******************************************************************************/
BOOLEAN LLCP_GetStart_Symm (void)
{
    return llcp_cb.lcb.start_symm;
}
/*******************************************************************************
 **Function             LLCP_StartSymm_Rsp
 *
 **Description          start symmetry response handle
 *
 **Returns              void
 *******************************************************************************/
void LLCP_StartSymm_Rsp(UINT8 event ,UINT8 reason)
{
    (*llcp_cb.lcb.p_link_cback) (event, reason);
}
#endif
/*******************************************************************************
**
...
#if (NFC_NXP_NOT_OPEN_INCLUDED_NCI_1_1 == TRUE)
    *p_start_symm           = LLCP_GetStart_Symm ();
#endif
...
#if (NFC_NXP_NOT_OPEN_INCLUDED_NCI_1_1 == TRUE)
    LLCP_TRACE_API1 ("                 start_symm:%d", *p_start_symm);
#endif
}
