 ...
 **Returns          tNFC_STATUS
 *******************************************************************************/
NFC_API extern tNFC_STATUS NFC_LlcpStartSymmetry (UINT8 remote_lto,
                                                  UINT8 local_lto);
/*******************************************************************************
 **Function         NFC_LlcpStopSymmetry
 **
 **Description      this function is called to stop llcp symmetry mechanism
 **
 **Returns          tNFC_STATUS
 *******************************************************************************/
NFC_API extern tNFC_STATUS NFC_LlcpStopSymmetry (void);
#endif
/*******************************************************************************
**
