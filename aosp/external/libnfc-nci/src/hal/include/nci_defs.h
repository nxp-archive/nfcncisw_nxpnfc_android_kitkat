...
#define NCI_MSG_RF_LLCP_SYMMETRY_START  12
#define NCI_MSG_RF_LLCP_SYMMETRY_STOP   13
#endif
/**********************************************
...
#if(NFC_NXP_NOT_OPEN_INCLUDED_NCI_1_1 == TRUE)
#define NCI_CORE_PARAM_SIZE_INIT        0x02
#else
...
#if (NFC_NXP_NOT_OPEN_INCLUDED_NCI_1_1 == TRUE)
#define NCI_INTERFACE_LLCP_LOW          4
#define NCI_INTERFACE_MAX               NCI_INTERFACE_LLCP_LOW
#else
...
#if (NFC_NXP_NOT_OPEN_INCLUDED_NCI_1_1 == TRUE)
/**********************************************
 * NCI RF Management / LLCP Group Params
 **********************************************/
#define NCI_LLCP_PARAM_SIZE_START           0x02 /*Remote lto, Local lto*/
#define NCI_LLCP_PARAM_SIZE_START_RSP       0x01 /* Status (1 octet) */
#define NCI_LLCP_PARAM_SIZE_STOP            0x00 /*Empty Payload*/
#define NCI_LLCP_PARAM_SIZE_STOP_RSP        0x01 /* Status (1 octet) */
#endif
/**********************************************
 * Supported Protocols
 **********************************************/
