...
#if(NFC_NXP_NOT_OPEN_INCLUDED_NCI_1_1 == TRUE)
    bool            enable_fw_symmetry;
    unsigned long   num = 0;
    GetNxpNumValue(NAME_NXP_ENABLE_LLCP_LOW, &num, sizeof(num));
    /* fw link management is enabled */
    if(num == 1)
            enable_fw_symmetry = TRUE;
    else
            enable_fw_symmetry = FALSE;
...
#if(NFC_NXP_NOT_OPEN_INCLUDED_NCI_1_1 == TRUE)
           ,enable_fw_symmetry   /*TRUE will enable FW symmetry*/
#endif
           );
